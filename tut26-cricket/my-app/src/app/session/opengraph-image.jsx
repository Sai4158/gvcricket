/**
 * File overview:
 * Purpose: Generates the social preview image for the sessions index route.
...
import {
  createSessionsIndexSocialImage,
  SOCIAL_IMAGE_SIZE,
...
export default async function OpenGraphImage() {
  ...
  const payload = await loadSessionsIndexPageData({
    page: 1,
    limit: 8,
    includeCounts: false,
  }).catch(() => null);

  return createSessionsIndexSocialImage(payload?.sessions || [], {
