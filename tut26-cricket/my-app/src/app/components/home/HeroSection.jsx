...
export default function HeroSection({ liveMatch = null }) {
  ...
  return (
    <section ref={sectionRef} className="relative h-[100svh] min-h-[100svh] overflow-hidden">
      <motion.div
        initial={shouldSimplifyMotion ? { opacity: 0.96 } : { opacity: 0.92, scale: 1.02 }}
        animate={{ opacity: 1, scale: 1 }}
        transition={{ duration: shouldSimplifyMotion ? 0.28 : 0.46, ease: [0.22, 1, 0.36, 1] }}
      ...
      >
        ...
        <div className="relative z-20 flex flex-col items-center px-4 pt-24 sm:pt-28 md:pt-18 lg:pt-16">
          <motion.div
            initial={shouldSimplifyMotion ? { opacity: 0 } : { y: 26, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ duration: shouldSimplifyMotion ? 0.28 : 0.42, delay: 0.08, ease: [0.22, 1, 0.36, 1] }}
            className="relative"
          >
            ...
            <motion.div
              style={shouldSimplifyMotion ? undefined : { scale: logoScrollScale, y: logoScrollY }}
              className={shouldSimplifyMotion ? "relative" : "relative will-change-transform"}
            >
              <motion.div
                animate={
                  shouldSimplifyMotion
          ...
          <motion.h1
            initial={shouldSimplifyMotion ? { opacity: 0 } : { y: 30, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
            transition={{ duration: shouldSimplifyMotion ? 0.32 : 0.46, delay: 0.14, ease: [0.22, 1, 0.36, 1] }}
          ...
          >
            ...
            <motion.div
              style={shouldSimplifyMotion ? undefined : { scale: headingScrollScale, y: headingScrollY }}
              className={shouldSimplifyMotion ? "relative z-10" : "relative z-10 will-change-transform drop-shadow-[0_12px_34px_rgba(0,0,0,0.68)]"}
            >
              <LiquidSportText
                as="span"
                text={heroLines}
                ...
                cursor={false}
                typing={false}
                characterTyping={!shouldSimplifyMotion}
                ...
                simplifyMotion={shouldSimplifyMotion}
        ...
        <motion.button
          ...
          transition={{ delay: 0.28, duration: shouldSimplifyMotion ? 0.24 : 0.34, ease: [0.22, 1, 0.36, 1] }}
        ...
        >
          ...
          <motion.span
            animate={shouldSimplifyMotion ? undefined : { y: [0, 5, 0], opacity: [0.8, 1, 0.8] }}
            transition={shouldSimplifyMotion ? undefined : { duration: 1.8, repeat: Infinity, ease: "easeInOut" }}
            className={`flex h-10 w-10 items-center justify-center rounded-full border border-white/24 shadow-[0_10px_24px_rgba(0,0,0,0.28)] ${
              shouldSimplifyMotion ? "bg-white/16" : "bg-white/12 backdrop-blur-md"
            }`}
          >
