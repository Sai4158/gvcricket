    ...
    <main className="min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(56,189,248,0.1),transparent_22%),radial-gradient(circle_at_bottom_right,rgba(16,185,129,0.08),transparent_24%),linear-gradient(180deg,#12141a_0%,#07080d_100%)] px-4 py-8 text-white">
      <div className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-md items-center justify-center">
        <section className="w-full rounded-[30px] border border-white/10 bg-[linear-gradient(180deg,rgba(20,20,24,0.96),rgba(8,8,12,0.98))] p-7 text-center shadow-[0_24px_80px_rgba(0,0,0,0.42)]">
          <div className="mx-auto inline-flex h-14 w-14 items-center justify-center rounded-full border border-cyan-300/18 bg-cyan-400/10 text-cyan-100 shadow-[0_12px_30px_rgba(34,211,238,0.14)]">
            <span
...
export default function Loading() {
  return (
    <RouteLoadingShell
      title="Opening umpire mode..."
      subtitle="Loading live scoring controls."
    />
  );
}
