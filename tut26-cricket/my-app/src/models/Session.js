...
const SessionSchema = new mongoose.Schema(
  {
    ...
    innings: { type: String, default: "", trim: true },
    result: { type: String, default: "", trim: true },
    pendingResult: { type: String, default: "", trim: true },
    winningTeamName: { type: String, default: "", trim: true },
    winningScore: { type: Number, default: 0 },
    winningWickets: { type: Number, default: 0 },
